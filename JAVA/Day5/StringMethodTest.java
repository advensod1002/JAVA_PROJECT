...
public class StringMethodTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("msg2 을 소문자로 변환하면...");
		...
		System.out.println("msg1 문자열의 크기(갯수)는?");
		System.out.println(msg1.length());
		
		System.out.println("msg2 문자열의 크기(갯수)는?");
		int len = msg2.length();		// 메소드 실행 결과값을 변수에 저장
		System.out.println(len);
		
		msg1 = "   koreait.2021@gmail.com   ";
		// 사용자는 모르고 공백을 시작할때나 끝나고 입력할 수 있지만 그 데이터를 처리할 때에는 공백을 없애야합니다
